...
namespace sourcenity {
    ...
    public class ShowLaserEffect : MonoBehaviour {
        ...
        [Header("Shader")]
        [Tooltip("The shader used to build the laser material")]
        public Shader lasershader = null;  
        ...
        private void Awake()
        {
            if (lasershader == null)
            {
                lasershader = Shader.Find("LaserShader");
            }
        }
        ...
        private void RefreshMaterial() {
            ...
            if (!visualization.Equals(ScLaserEffectVisual.CustomMaterial)) {
                if (cachedMaterial == null) {
                    cachedMaterial = new Material(lasershader);
                }
